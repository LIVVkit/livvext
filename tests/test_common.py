...
def test_check_longitude():
    ...
    lons_2 = np.arange(0, 360, 45.)
    _shift_lons = np.array([   0.,   45.,   90.,  135., -180., -135.,  -90.,  -45.])
    ...
    _ds1 = _ds1 = xr.Dataset(data_vars={"x": (["lon"], test_data)}, coords={"lon": lons_2})
